...
const router = new VueRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      name: "bulktest",
      component: (resolve) =>
        require(["../components/BulkSubmission.vue"], resolve),
      meta: {
        permission: AutoritityMap["admin"],
      },
    },
    ...
    },
    {
      ...
      component: (resolve) =>
        require(["../components/AnnouncementDisplay.vue"], resolve),
      meta: {
        permission: AutoritityMap["student"],
      },
    },
    {
      ...
      component: (resolve) =>
        require(["../components/QuestionDisplay.vue"], resolve),
      meta: {
        permission: AutoritityMap["student"],
      },
    },
    ...
    // os related pages
    {
      ...
      component: (resolve) =>
        require(["../components/OsGradeList.vue"], resolve),
      meta: {
        permission: AutoritityMap["student"],
      },
    },
...
router.beforeEach((to, from, next) => {
  ...
  if (to.path === "/login") {
    ...
    if (token === null || token === "") {
      ...
      parseInt(permission) >= parseInt(to.meta.permission)
        ? next()
        : next("/404");
    } else {
      next();
