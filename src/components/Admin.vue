<template>
  <div id="admin" style="min-width: 1100px">
    <h1 style="font-size: 25px; text-align: center; line-height: 1.7">
      Admin: 添加教师用户
    </h1>
    <el-upload
    ...
    >
      ...
      <div class="el-upload__text">
        上传“<b>*.xls(x)</b>”文件。(含表列“学号”与“姓名”)<br />拖到此处，或<em
          >点击上传</em
        >
      </div>
    </el-upload>
    <el-table :data="teachers" stripe height="250" style="width: 50%">
      <el-table-column prop="id" label="学工号" sortable width="180">
      </el-table-column>
